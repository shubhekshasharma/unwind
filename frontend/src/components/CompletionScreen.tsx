      ...
      <div className="relative size-full flex flex-col items-center justify-between p-6">
        <div className="flex-1 flex flex-col items-center justify-center space-y-7">
          ...
          >
            ...
            <p className="text-orange-200/75 text-base max-w-xs" style={{ fontWeight: 400 }}>
          ...
          >
            <div className="bg-gradient-to-br from-orange-950/30 to-amber-950/25 rounded-2xl border border-orange-800/20 p-5">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-sm text-orange-300/85" style={{ fontWeight: 500 }}>Tonight's session</span>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between text-sm">
                  <span className="text-orange-200/70" style={{ fontWeight: 400 }}>Unwind time</span>
                  <span className="text-orange-100" style={{ fontWeight: 500 }}>{durationStr}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-orange-200/70" style={{ fontWeight: 400 }}>Phone pickups</span>
                  <span className={pickupCount === 0 ? 'text-green-400' : 'text-orange-200'} style={{ fontWeight: 500 }}>
                    {pickupCount === 0 ? 'None ✓' : pickupCount}
                  </span>
                </div>
                <div className="h-px bg-orange-800/25 my-0.5" />
                <div className="flex justify-between text-sm">
                  <span className="text-orange-200/70" style={{ fontWeight: 400 }}>Bedtime</span>
                  <span className="text-orange-100" style={{ fontWeight: 500 }}>{fmt12h(prefs.bedtime)}</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-amber-950/20 border border-amber-800/20">
              ...
              <div>
                <div className="text-sm text-white" style={{ fontWeight: 500 }}>Wake: {fmt12h(prefs.wakeTime)}</div>
                <div className="text-xs text-amber-300/70" style={{ fontWeight: 400 }}>Good morning awaits</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <Moon className="w-9 h-9 text-orange-400/45 mx-auto" />
        ...
        >
          <button
            ...
            className="w-full py-3.5 rounded-2xl bg-orange-950/25 border border-orange-800/20 text-orange-300/80 hover:text-orange-200 transition-colors text-sm"
          ...
          <button
            ...
            className="w-full py-3 rounded-2xl bg-orange-950/15 border border-orange-800/15 text-orange-400/60 hover:text-orange-300/80 transition-colors text-sm"
            style={{ fontWeight: 400 }}
          >
            Back to home
          </button>
